...
#ifndef JSgranulatorFXParams_H
#define JSgranulatorFXParams_H
...
struct JSgranulatorNonRTPCParams
{
};

struct JSgranulatorFXParams
    : public AK::IAkPluginParam
{
    JSgranulatorFXParams();
    JSgranulatorFXParams(const JSgranulatorFXParams& in_rParams);
    ...
    JSgranulatorRTPCParams RTPC;
    JSgranulatorNonRTPCParams NonRTPC;
};

#endif // JSgranulatorFXParams_H
