...
#ifndef JSgranulatorConfig_H
#define JSgranulatorConfig_H
...
namespace JSgranulatorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 28327;
}

#endif // JSgranulatorConfig_H
